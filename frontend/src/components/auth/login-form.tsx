...
export function LoginForm() {
  ...
  const submit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      const memoryToken = data.token as string | undefined;
      const isAdmin = Boolean(data.is_admin);
      setSession(normalized, remember ? null : memoryToken ?? null, isAdmin);
  ...
  return (
    <div className="min-h-screen grid lg:grid-cols-2">
      <LoginInfoCarousel />
      <div className="flex items-center justify-center bg-white p-6 lg:p-10 min-h-[420px] lg:min-h-screen">
        <div className="w-full lg:w-[75%] bg-white rounded-sm shadow-sm border border-gray-200 p-8 lg:p-12">
