...
import { AdmissionJourneySidebar } from '@/components/layout/admission-journey-sidebar';
import { PublishedDataBanner } from '@/components/dashboard/published-data-banner';
import { useAuthBootstrap } from '@/hooks/use-auth-bootstrap';
import { cn } from '@/lib/utils';

export function AdmissionJourneyShell({ children }: { children: React.ReactNode }) {
