...
# Admissions — All Payments sheet (manual upload or Google sync).
ADMISSIONS_TABLE = "admissions_tracking"
ADMISSIONS_PARQUET_FILE = "admissions_tracking.parquet"
ADMISSIONS_META_FILE = "admissions_meta.json"

ADMISSIONS_COLUMN_ALIASES: Dict[str, str] = {
    "id": "sheet_id",
    "s. no.": "sheet_id",
    "s no.": "sheet_id",
    "sno": "sheet_id",
    ...
    "paidat": "paid_at",
    "paid at": "paid_at",
    "semester fee paid dop": "paid_at",
    "semesterfeepaiddop": "paid_at",
    "paymentid": "payment_id",
    "payment id": "payment_id",
    "status": "status",
    "semester i amount payment status": "status",
    "semesteriamountpaymentstatus": "status",
    "semester i amount payment mode": "sem1_payment_mode",
    "semesteriamountpaymentmode": "sem1_payment_mode",
    "semester ii amount payment status": "sem2_payment_status",
    "semesteriiamountpaymentstatus": "sem2_payment_status",
    "semester ii amount payment mode": "sem2_payment_mode",
    "semesteriiamountpaymentmode": "sem2_payment_mode",
    "semester amount utr no / transaction id": "sem_utr",
    "semesteramountutrno/transactionid": "sem_utr",
    "sem payment to (university)": "sem_payment_to",
    "sempaymentto(university)": "sem_payment_to",
    "block amount utr no / transaction id": "block_utr",
    "blockamountutrno/transactionid": "block_utr",
    "block amount paid": "block_amount_paid_sheet",
    "blockamountpaid": "block_amount_paid_sheet",
    "block amount payment status": "block_payment_status",
    "blockamountpaymentstatus": "block_payment_status",
    "block amount payment mode": "block_payment_mode",
    "blockamountpaymentmode": "block_payment_mode",
    "transferid": "transfer_id",
    "transfer id": "transfer_id",
    "transferpending": "transfer_pending",
    "transfer pending": "transfer_pending",
    "transferstatus": "transfer_status",
    "transfer status": "transfer_status",
    "updatedat": "updated_at",
    "updated at": "updated_at",
    "refund status": "refund_status",
    "campus change status": "campus_change_status",
    "campuschangestatus": "campus_change_status",
}

ADMISSIONS_COLUMNS: List[str] = [
    "sheet_id",
    "student_name",
    "email",
    "phone",
...
# LMS fee verification sheet (Google sync).
ADMISSIONS_LMS_TABLE = "admissions_lms_tracking"
ADMISSIONS_LMS_PARQUET_FILE = "admissions_lms_tracking.parquet"
ADMISSIONS_LMS_META_FILE = "admissions_lms_meta.json"

ADMISSIONS_LMS_COLUMN_ALIASES: Dict[str, str] = {
    "s. no.": "serial_no",
    "s no.": "serial_no",
    "sno": "serial_no",
    ...
    "semester": "semester",
    "status": "status",
    "payable (inr)": "payable_inr",
    "payable(inr)": "payable_inr",
    "payable": "payable_inr",
    "verified paid (inr)": "verified_paid_inr",
    "verifiedpaid(inr)": "verified_paid_inr",
    "verified paid": "verified_paid_inr",
    "pending (inr)": "pending_inr",
    "pending(inr)": "pending_inr",
    "pending": "pending_inr",
    "remaining (inr)": "remaining_inr",
    "remaining(inr)": "remaining_inr",
...
ADMISSIONS_LMS_COLUMNS: List[str] = [
    "serial_no",
    "candidate_name",
    "email",
    "phone",
